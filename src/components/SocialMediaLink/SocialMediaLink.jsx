...
const SocialMediaLink = () => {
   ...
   return (
      <>
         <div className="col-lg-12 hero-banner-inner">
                  ...
                  <div className="row">
                     <div className="col-md-6 col-sm-4 ">
                        <div className="soclial-link-top">
                           ...
                           <div className="search-container d-flex">
                              <button className="btn btn-primary search-btn" id="searchButton">
                     ...
                     <div className="col-md-6 col-sm-8 ">
                        <div className="resize-content ">
                           <span><Link to={"#welcome"} href="#welcome" className="skip">Skip to Main Content</Link></span>
